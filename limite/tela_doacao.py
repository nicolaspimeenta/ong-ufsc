    ...
    def cadastrarDoacao(self, pessoas, animais):
        ...
        while True:
            layout = [
                ...
                [sg.Text('Selecione a pessoa que está doando', font=('Arial', 10))],
            ]
            if len(pessoas) == 0:
        ...
        while True:
            layout = [
                ...
                [sg.Text('Selecione o animal que está sendo doado', font=('Arial', 10))],
            ]
            if len(animais) == 0:
            ...
            if valores[0] == 'Confirmar':
                for key, value in valores[1].items():
                    ...
                    if animal.dono != doador and animal.dono:
                        sg.popup('ERRO', 'Esse animal pertence a outra pessoa')
                        self.window.close()
                        continue
